...
resource "aws_iam_role" "OrganizationPractice_role" {
  ...
  assume_role_policy = file("iam_json/OrganizationPractice_role/OrganizationPractice_role_assume.json")
...
resource "aws_iam_role" "InstanceScheduler_role" {
  ...
  assume_role_policy = file("iam_json/InstanceScheduler_role/assume_role_policy.json")
...
resource "aws_iam_policy" "InstanceScheduler_role_policy" {
  ...
  policy = file("iam_json/InstanceScheduler_role/role_policy.json")
}
